...
public enum ExceptionEnums {
    ...
    BUCKET_NAME_NOT_EXIST("0005", "桶不存在，需要先创建桶在创建文件夹"),
    MINIO_CONFIG_NULL("0006","minio配置为空"),
    BUCKET_CREATE_FAIL("0007","桶创建失败"),
    BUCKET_ACQUIRE_FAIL("0007","获取全部桶失败"),
            ;//枚举类如果写方法的话，此处需要写分号
